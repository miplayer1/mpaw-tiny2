<section id="contact" class="scrollspy">
	<div class="container">
	 <div class="row">
	    <div class="col s12">
	      <h2 class="dark-green center-align">Pour en savoir plus, obtenir un devis personnalisé, contactez-nous et nous reviendrons vers vous très rapidement : </h2>	      
	     </div>
	    ...
	    <form class="col s12" action="#contact" method="POST">
	      ...
	      <div class="row">
	        <div class="col s12 center-align">
	          <button class="btn waves-effect waves-light amber accent-4" id="submit" type="submit" name="submit">Envoyer
